...
class Flat(models.Model):
    ...
    liked_by = models.ManyToManyField(User, related_name='liked_flats',
        verbose_name='Понравилась пользователям', blank=True)
...
class Appeal(models.Model):
    ...
    flat = models.ForeignKey(Flat, on_delete=models.CASCADE,
        verbose_name='На какую квартиру жалоба', related_name='flat_appeals')
    text = models.TextField('Текст жалобы')

    def __str__(self):
        return f'{self.user.username}, {self.flat.id}'